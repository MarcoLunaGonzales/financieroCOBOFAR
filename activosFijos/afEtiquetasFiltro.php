...
<div class="content">
	<div class="container-fluid">
		<div class="col-md-12">
		  <form id="form1" class="form-horizontal" action="activosFijos/afEtiquetasPrint2.php" method="post" target="_blank">
			<div class="card">
          ...
          <div class="row">
              ...
              <div class="col-sm-7">
              <div class="form-group">
                  <select class="selectpicker form-control" title="Seleccione una opcion" name="rubros[]" id="rubros" data-style="select-with-transition" data-size="5" data-actions-box="true" multiple required>
