		...
		<div class="col-md-12">
		  <form id="form1" class="form-horizontal" action="<?=$urlSave_cambiar_resp?>" method="post">
			<div class="card">
			  ...
			  <div class="card-body ">                
                <div class="row">
                    <label class="col-sm-2 col-form-label">Resposanble 1</label>
                    <div class="col-sm-4">
                    ...
                    <label class="col-sm-2 col-form-label">Resposanble 2</label>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <select name="cod_responable2" id="cod_responable2" class="selectpicker form-control form-control-sm" data-style="btn btn-primary"  data-show-subtext="true" data-live-search="true">
                                <option value=""></option>
                                <?php 
                                $query = "SELECT codigo,paterno,materno,primer_nombre from personal where cod_estadoreferencial=1";
                                $statement = $dbh->query($query);
                ...
                <div class="row">
                    <label class="col-sm-2 col-form-label">Nuevo Respo. 1</label>
                    <div class="col-sm-4">
                        <div class="form-group">
                    ...
                    <label class="col-sm-2 col-form-label">Nuevo Respo. 2</label>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <select name="nuevo_cod_responable2" id="nuevo_cod_responable2" class="selectpicker form-control form-control-sm" data-style="btn btn-primary"  data-show-subtext="true" data-live-search="true" >
                                <option value=""></option>
                                <?php 
                                $query = "SELECT codigo,paterno,materno,primer_nombre from personal where cod_estadoreferencial=1";
                                $statement = $dbh->query($query);
