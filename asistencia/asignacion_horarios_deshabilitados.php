...
where h.cod_estadoreferencial=0
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-info card-header-icon">
            <div class="card-icon" style="background:#353535 !important;color:white;">
              <i class="material-icons">more_time</i>
            </div>
            <h4 class="card-title">Horarios Eliminados</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <div class="" id="data_activosFijos">
                <table class="table table-condensed small table-bordered" id="tablePaginatorHead">
                  <thead>
                    <tr class="bg-success" style="background: #888888 !important;color:white;">
                      <td class="text-center"></td>
                      <td class="text-center"></td>
                      <td class="text-center"></td>
                      <td class="text-center"></td>
                      <td class="text-center" colspan="2">CONTINUO</td>                      
                      <td class="text-center" colspan="2" style="background: #353535;">TURNO MAÑANA</td>                      
                      <td class="text-center" colspan="2" style="background: #353535;">TURNO TARDE</td>                      
                      <td class="text-center" colspan="2" style="background: #353535;">TURNO NOCHE</td>                      
                      <td class="text-center"></td>
                      <td class="text-center"></td>
                      <td class="text-center"></td>
                    </tr>
                    <tr class="bg-success" style="background: #888888 !important;color:white;">
                      ...
                      <td class="text-center" style="background: #353535;">INGRESO</td>
                      <td class="text-center" style="background: #353535;">SALIDA</td>                      
                      <td class="text-center" style="background: #353535;">INGRESO</td>
                      <td class="text-center" style="background: #353535;">SALIDA</td>                      
                      <td class="text-center" style="background: #353535;">INGRESO</td>
                      <td class="text-center" style="background: #353535;">SALIDA</td>                                            
                     ...
                     ?>
                      <tr>
                          ...
                          <td class="td-actions text-right">
                            <?php
                            if($activoX==0){
                            ?> <a href="asistencia/asignacion_horarios_delete.php?codigo=<?=$codigoX?>&e=1" > 
                                  <i class="material-icons" title="Eliminar" style="color:green">restore_from_trash</i>
                                </a><?php
                            }
                            ?>
        ...
        <div class="card-footer fixed-bottom">           
          <a class="btn btn-default text-white btn-round" href="?opcion=rpt_asignacion_horarios_from">Volver</a>
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="form-group">                  
              <select name="modal_area" id="modal_area" class="selectpicker form-control form-control-sm" data-style="btn btn-primary">
        ...
        <div class="row col-sm-10">
          <table class="table table-condensed table-bordered">
            <tr class="bg-warning" style="background:#69C401 !important;color:white;">
              ...
              <td colspan="2" style="background:#888888 !important;color:white;" class="clase_4">HORARIO CONTINUO</td>
            </tr>
            <tr class="bg-warning" style="background:#69C401 !important;color:white;">
              ...
              <td style="background:#888888 !important;color:white;" class="clase_4">INGRESO</td>
              <td style="background:#888888 !important;color:white;" class="clase_4">SALIDA</td>
            </tr>
            <tr>
