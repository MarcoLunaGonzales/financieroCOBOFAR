            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header <?=$colorCard;?> card-header-icon">
                  ...
                  <h4 class="card-title">Asistencia del Personal <span style="color:blue"><b><?=$nombreSucursal?></b></span></h4>
                </div>
                <div class="card-body">
                        ...
                        while ($rowdet = $stmtDet->fetch(PDO::FETCH_BOUND)) { 
                          ...
                          <tr <?=$label_mes?>>
                            ...
                            <td class="td-actions text-left">
                              ...
                              <a  href="asistencia_cuadro/asistencia_detalle.php?codigo=0&q=<?=$q?>&s=<?=$s?>&cod_mes=<?=$codigoMes?>&cod_gestion=<?=$nombreGestion?>" class="btn btn-success btn-sm btn-round <?=$btn_register?>"><i class="material-icons" title="Registrar Cuadro de asistencia">add</i></a>
                            </td>
                          </tr>
                        <?php
                          $index++;
