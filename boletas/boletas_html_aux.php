			...
			$html.='<table width="100%" class="table" style="font-size:12px;">
				...
				<td width="50%" valign="top">
					<table width="100%">
						...
						<tr>
							<td class="text-left" style="border: 0;font-family:Arial, sans-serif;" valign="top">Ap. Vejez 10%<br>Riesgo Prof. 1.71%<br>Com.AFP 0.5%<br>Apo.Sol 0.5%<br>Apo.Sol(13)<br>Apo.Sol(25)<br>Apo.Sol(35)<br>RC IVA<br>Anticipos<br>Prestamos<br>Inventario<br>Vencidos<br>Atrasos<br>Faltantes Caja<br>Otros Descuentos<br>Aporte Sindical</td>
							<td class="text-right" style="border: 0;font-family:Arial, sans-serif;" valign="top">'.formatNumberDec($Ap_Vejez).'<br>'.formatNumberDec($Riesgo_Prof).'<br>'.formatNumberDec($ComAFP).'<br>'.formatNumberDec($aposol).'<br>'.formatNumberDec($aposol13).'<br>'.formatNumberDec($aposol25).'<br>'.formatNumberDec($aposol35).'<br>'.formatNumberDec($RC_IVA).'<br>'.formatNumberDec($Anticipos).'<br>'.formatNumberDec($Prestamos).'<br>'.formatNumberDec($Inventario).'<br>'.formatNumberDec($Vencidos).'<br>'.formatNumberDec($Atrasos).'<br>'.formatNumberDec($Faltantes_Caja).'<br>'.formatNumberDec($Otros_Descuentos).'<br>'.formatNumberDec($Aporte_Sindical).'</td>
						</tr>
						<tr>
				...
				<td style="background:#F2F2F2;border-right: 0;">';
                        ...
                        $contenido = '186.121.247.102:8888/cobofar_catalogo/blts/vb.php?ws='.$codigo_generado;
