              ...
              <table id="tablePaginatorHeaderFooter" class="table table-bordered table-condensed table-striped  table-sm table-secondary" style="width:100%">
                ...
                <thead>                              
                  <tr>
                    ...
                    <th><small><b>Fal tas</b></small></th>
                    <th><small><b>Perm isos Sin Desc</b></small></th>
                    <th><small><b>Dias Vac.</b></small></th>
                    <th><small><b>Dias Traba jados L_S</b></small></th>
                    <th><small><b>Domi ngos Normal</b></small></th>
                    <th><small><b>Feri ado Normal</b></small></th>
                    <th><small><b>No che Nor mal</b></small></th>
                    <th><small><b>Domi ngo Reem</b></small></th>
                    <th><small><b>Feri ado Reem</b></small></th>
                    <th><small><b>Ordi nario Reem</b></small></th>
                    <th><small><b>HXdom ingo Extras</b></small></th>
                    <th><small><b>HXFer iado Extras</b></small></th>
                    <th><small><b>HXD Normal Extras</b></small></th>
                    <th><small><b>REINT EGRO (BS)</b></small></th>
                    <th><small><b>OBS REINTEGRO (BS)</b></small></th>
                    <th><small><b>ANTI CIPOS</b></small></th>
                    
                    <th><small><b>Prest amos</b></small></th>
                    <th><small><b>Inven tarios</b></small></th>
                    <th><small><b>Venci dos</b></small></th>
                    <th><small><b>Atra sos</b></small></th>
                    <th><small><b>Falta nte Caja</b></small></th>
                    <th><small><b>Otros Desc</b></small></th>
                    <th><small><b>Aport Sindi</b></small></th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">        
        ...
        <div class="row">
          ...
          <div class="col-sm-1">
            <div class="form-group" >              
              <input type="text" class="form-control" name="anticipo_e" id="anticipo_e" style="background-color:white">
            </div>
          </div>
          <label class="col-sm-2 col-form-label text-dark  text-right">Prestamos : </label>
          <div class="col-sm-1">
            <div class="form-group" >
              <input type="text" class="form-control" name="prestamos_e" id="prestamos_e" style="background-color:white">              
            </div>
          </div>
          <label class="col-sm-2 col-form-label text-dark  text-right">Inventarios : </label>
          <div class="col-sm-1">
            <div class="form-group" >              
              <input type="text" class="form-control" name="inventarios_e" id="inventarios_e" style="font-weight: bold;background: white; color:green" readonly="true">
            </div>
          </div>
          <label class="col-sm-2 col-form-label text-dark  text-right">Vencidos : </label>
          <div class="col-sm-1">
            <div class="form-group" >
              <input type="text" class="form-control" name="vencidos_e" id="vencidos_e" style="font-weight: bold;background: white; color:green" readonly="true">              
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-1">
            <div class="form-group" >              
              <input type="text" class="form-control" name="atrasos_e" id="atrasos_e" style="background-color:white">
            </div>
          </div>
          <label class="col-sm-2 col-form-label text-dark  text-right">Faltante en Caja : </label>
          <div class="col-sm-1">
            <div class="form-group" >
              <input type="text" class="form-control" name="faltante_caja_e" id="faltante_caja_e" style="font-weight: bold;background: white; color:green" readonly="true">              
            </div>
          </div>
          <label class="col-sm-2 col-form-label text-dark  text-right">Otros Descuentos : </label>
          <div class="col-sm-1">
            <div class="form-group" >
              <input type="text" class="form-control" name="otros_descuentos_e" id="otros_descuentos_e" style="font-weight: bold;background: white; color:green" readonly="true">
            </div>
          </div>
          <label class="col-sm-2 col-form-label text-dark  text-right">Aporte Sindicato : </label>
          <div class="col-sm-1">
            <div class="form-group" >
              <input type="text" class="form-control" name="aporte_sindicato_e" id="aporte_sindicato_e" style="font-weight: bold;background: white; color:green" readonly="true">              
            </div>
          </div>
        </div>
      </div>
