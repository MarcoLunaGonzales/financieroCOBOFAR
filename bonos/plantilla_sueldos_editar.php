    ...
    <div class="modal-content">
      ...
      <div class="modal-body">        
        ...
        <div class="row">
          ...
          <div class="col-sm-1">
            <div class="form-group" >
              <input type="text" class="form-control" name="vencidos_e" id="vencidos_e" style="background-color:white">              
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-1">
            <div class="form-group" >
              <input type="text" class="form-control" name="faltante_caja_e" id="faltante_caja_e" style="background-color:white">              
            </div>
          </div>
          <label class="col-sm-2 col-form-label text-dark  text-right">Otros Descuentos : </label>
          <div class="col-sm-1">
            <div class="form-group" >
              <input type="text" class="form-control" name="otros_descuentos_e" id="otros_descuentos_e" style="background-color:white">              
            </div>
          </div>
          <label class="col-sm-2 col-form-label text-dark  text-right">Aporte Sindicato : </label>
          <div class="col-sm-1">
            <div class="form-group" >
              <input type="text" class="form-control" name="aporte_sindicato_e" id="aporte_sindicato_e" style="background-color:white">              
            </div>
          </div>
        </div>
      </div>
