   ...
   <div class="col-sm-4">
    ...
    <div class="col-sm-1">
            <div class="form-group">
              ...
              <input class="form-control small clase_saldo" type="text" placeholder="0" value="<?=$debe?>" name="debe<?=$idFila;?>" id="debe<?=$idFila;?>" onblur="calcularTotalesComprobante(this.id,event);" onkeypress="return valideKey(event);" onkeyup="moverFlechas(event);" step="0.01"> 
      </div>
    </div>
    <div class="col-sm-1">
            <div class="form-group">
              <!--<label class="bmd-label-floating">Haber</label>     -->
              <input class="form-control small clase_saldo" type="text" placeholder="0" value="<?=$haber?>" name="haber<?=$idFila;?>" id="haber<?=$idFila;?>" onblur="calcularTotalesComprobante(this.id,event);" onkeypress="return valideKey(event);" onkeyup="moverFlechas(event);" step="0.01">   
      </div>
    </div>
    <div class="col-sm-3">
        <div class="form-group">
