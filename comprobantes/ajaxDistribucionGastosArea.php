 ...
 <div class="col-md-12">
  <div class="row">
    <div class="col-sm-1">
          ...
          <select class="selectpicker form-control form-control-sm" name="unidad<?=$idFila;?>" id="unidad<?=$idFila;?>" data-style="btn btn-primary" onChange="relacionSolicitudesSIS(<?=$idFila;?>)" data-live-serach="true">
               <?php
              ...
              ?>
                      <option value="<?=$codigoX;?>" selected data-subtext="<?=$nombreX?>"><?=$abrevX;?></option>
              <?php
                    }
                  }
              ?>
