...
$stmt->bindColumn('autoriza', $auto);
$stmt->bindColumn('codigo', $codigo);
$stmt->bindColumn('imp_base', $importe);
?>
...
<thead>
  <tr>
    ...
    <th><small><small><b>NOMBRE</b></small></small></th>
    ...
    <th><small><small><b>NOMBRE BD</b></small></small></th>
...
<tbody>
  ...
  while ($row = $stmt->fetch(PDO::FETCH_BOUND)) { 
    $datos=verificar_autorizacion_fac($auto,$nfactura);
    if($datos=='NO ENCONTRADO'){
      $datos=verificar_nit_control($nit,$codigo);
    }
    if($datos=='NO ENCONTRADO'){
