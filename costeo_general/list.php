        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            ?>           
              ...
              <a class="btn btn-info" target="blank" style="background: #08B8BA;height: 100px;padding-top: 25px;" href="reportes_comercial/rptOp_movimientos_costo_sucursales.php"><i class="material-icons" style="font-size: 60px;">query_stats</i><br><br><br>REPORTE VALORADO SUCURSALES</a>
              <a class="btn btn-info" target="blank" style="background: #1C2833;height: 100px;padding-top: 10px;" href="reportes_comercial/rptOp_movimientos_costo_sucursales_ingresos.php"><i class="material-icons" style="font-size: 30px;">query_stats</i><br><br><br>REPORTE VALORADO SUCURSALES<br>INGRESO DETALLADO</a>
              <a class="btn btn-info" target="blank" style="background: #828282;height: 100px;padding-top: 25px;" href="reportes_comercial/rptOp_movimientos_costo_proveedor.php"><i class="material-icons" style="font-size: 60px;">query_stats</i><br><br><br>REPORTE VALORADO SUCURSAL - PROVEEDORES</a>
