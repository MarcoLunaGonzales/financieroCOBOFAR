...
<div id="comp_row" class="col-md-12">
  <div class="row">
    ...
    <div class="col-sm-1">
        <div class="form-group">
          <input type="number" step="0.01" min="0" id="monto_sistema<?=$idFila;?>" name="monto_sistema<?=$idFila;?>" class="form-control text-primary text-right" value="0" required="true" onkeyUp="diferencia_descuento_personal(<?=$idFila?>)">
      </div>
    </div>
    <div class="col-sm-1">
      <div class="form-group">
