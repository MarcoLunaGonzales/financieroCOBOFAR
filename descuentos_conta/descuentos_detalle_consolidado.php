                    ...
                    <div class="card">
                                ...
                                <table class="table table-condensed table-bordered table-striped table-secondary" >
                                    ...
                                    <tfoot>
                                        <tr style="background:#18537e;color:white;">
                                            ...
                                            <td class="text-right" ><small><?=$label_saldo?><?=formatNumberDec($Sumasaldo_descuento,2)?></span></small></td>
                                            <td class="text-right" ><small>-</small></td>
                        ...
                        <div class="card-footer fixed-bottom">
                            ...
                            if($contadorError==0){?>
                                ...
                                <button  type="button" onclick="window.close();" class="btn btn-danger btn-sm" >Cancelar</button>
                            <?php } ?>                            
                        </div>
                    </div>
            </div>
