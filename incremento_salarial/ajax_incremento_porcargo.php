...
$string_cargos=$_GET['string_cargos'];
...
while ($rowNoAdmitidos = $stmtNoAdmitidos->fetch(PDO::FETCH_BOUND)) {
  $glosa_cargos_admitidos.=$nombre_cargo_x.", ";
}
           ...
           <div class="card-body">
              <table>
                 <tr>
                    ...
                    <td>
                       <div class="row">
                          <h5 class="card-title" style="color:#e6b0aa;"><b>INCREMEMENTO POR CARGO <?=$anio?></b></h5>
                       </div>
                       <div class="row">
                          <div class="col-sm-1">
           ...
           <div class="card-body">
              <table>
                 <tr>
                    <td>
                       <div class="row">
                          <h5 class="card-title" style="color:#566573;"><b>CARGOS BANEADOS: </b><small><small><?=$glosa_cargos_admitidos?></small></small></h5>   
                       </div>
                    </td>
                 </tr>
              </table>
                ...
                <table class="table table-bordered table-condensed table-sm " id="tablePaginatorHead">
                  ...
                  <tbody>
                    ...
                    $query="SELECT p.codigo,p.cod_cargo,p.primer_nombre,p.paterno,p.materno,(select c.nombre from cargos c where c.codigo=p.cod_cargo)as cargo,a.nombre as area,p.haber_basico
                      ...
                      where p.cod_estadopersonal=1 and p.cod_estadoreferencial=1  and p.cod_cargo in ($string_cargos)
                    ...
                    <?php
                     ...
                     where p.cod_estadopersonal=3 and pr.fecha_retiro BETWEEN '$fecha_inicio' and '$fecha_fin' and p.cod_cargo in ($string_cargos)
                     order by p.cod_unidadorganizacional,a.nombre, p.turno";
