                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_BOUND)) {
                      ...
                      <tr <?=$estilo?>>
                        <td align="center"><?=$index+1;?>
                           ...
                           <input type="hidden" name="personal_seleccionado<?=$index?>" id="personal_seleccionado<?=$index?>"  value="0"/></td>
                        ...
                        <td class="text-right">
                           <div class="togglebutton">
                              <label>
                                 <input type="checkbox"  id="personal_seleccionado_x<?=$index?>" name="personal_seleccionado_x<?=$index?> " onchange="activar_input_incremento_salarial_personal(<?=$index?>)" >
                     ...
                     while ($rowRetirados = $stmtRetirados->fetch(PDO::FETCH_BOUND)) {
                        ...
                        <tr <?=$estilo?>>
                           <td align="center"><?=$index+1;?>
                              ...
                              <input type="test" name="personal_seleccionado<?=$index?>" id="personal_seleccionado<?=$index?>" value="0"/></td>
