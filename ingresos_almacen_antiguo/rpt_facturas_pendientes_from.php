...
<div class="content">
	<form id="form1" class="form-horizontal" action="../ingresos_almacen_antiguo/rpt_facturas_pendientes_print.php" method="GET"  target="_blank">
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header <?=$colorCard;?> card-header-icon">
              ...
              <h4 class="card-title">Pendientes Ingresos Almacén</h4>
            </div>
            <div class="card-body">
	            <div class="row">	                  	
