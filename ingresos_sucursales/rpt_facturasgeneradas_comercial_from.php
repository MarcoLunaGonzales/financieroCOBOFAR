...
<div class="content">
  <div class="container-fluid">
    <div class="col-md-12">
      <form id="form1" class="form-horizontal" action="ingresos_sucursales/rpt_facturasgeneradas_comercial_print.php" method="post"  target="_blank">
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
           ...
           <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <select class="selectpicker form-control" title="Seleccione una opcion" name="sucursal" id="sucursal" data-style="select-with-transition" data-size="5" data-actions-box="true"  required data-show-subtext="true" data-live-search="true">
                  <?php 
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <select class="selectpicker form-control" title="Seleccione una opcion" 
                  ...
                  <?php 
                    $query = "SELECT codigo,paterno,materno,primer_nombre from personal where cod_estadopersonal=1 and cod_estadoreferencial=1 order by paterno";
