...
<div class="sidebar" data-color="purple" data-background-color="<?=$estiloMenu?>" data-image="assets/img/scz.jpg">
      <div class="logo">
        <a href="" class="simple-text logo-mini">
          <img src="assets/img/icono_pastilla.png" width="40"/>
        </a>
      ...
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
               ...
               <!--  <li class="nav-item ">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="?opcion=permisosPersonalListaRRHH"  style="background:#dab6aa; color:#584f4c;font-weight:bold;">
                      ...
                      <span class="sidebar-normal">Aprobación de Permisos</span>
                    </a>
                </li>
          ...
          <!--TRANSACCIONES RRHH-->
          <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#transaccHHRR_pla">
              <i class="material-icons">menu</i>
              <p> Transacciones Planillas
                <b class="caret"></b>
              </p>
            </a>
