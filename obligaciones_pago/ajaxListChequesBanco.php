...
<div class="form-group">
     <select class="selectpicker form-control form-control-sm" onchange="ponerNumeroChequePagoDetalle_lotes(this)" data-live-search="true" name="emitidos_pago_s" id="emitidos_pago_s" data-style="btn btn-primary" required="true">
