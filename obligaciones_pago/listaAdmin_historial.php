...
// Preparamos
$stmt = $dbh->prepare("SELECT sr.*,(select t.nombre from tipos_pagoproveedor t where t.codigo=sr.cod_ebisalote)as tipo_pago,e.nombre as estado from pagos_lotes sr join estados_pago e on sr.cod_estadopagolote=e.codigo where cod_estadoreferencial=1 and sr.cod_estadopagolote in (3,5) order by sr.codigo desc limit 50 ");
// Ejecutamos
$stmt->execute();
// bindColumn
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-icon">
                  <div class="card-icon" style="background:  #566573 ;">
                    <i class="material-icons">attach_money</i>
                  </div>
                  <h4 class="card-title"><b>Pagos Proveedores ADM Histórico</b></h4>
                </div>
                <div class="card-body">
                    <table class="table table-condesed small" id="tablePaginator">
                      <thead>
                        <tr style="background: #566573 ; color:#fff;">
                          <th>Nro</th>
                          <th>Nombre</th>
                          <th>Fecha Pago</th>
                          <th>Tipo Pago</th>
