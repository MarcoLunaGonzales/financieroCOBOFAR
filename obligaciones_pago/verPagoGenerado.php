      ...
      <div class="row">
        <div class="col-sm-12">
                ...
                while ($row = $stmt->fetch(PDO::FETCH_BOUND)) {
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      <input type="text" class="form-control" readonly="true" value="<?=$nro_correlativo?>" style="background-color:#E3CEF6;text-align: left" >
                    </div>
                  </div>
                  </div>
                  <div class="row">
