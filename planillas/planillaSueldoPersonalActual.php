                    ...
                    if($cod_uo_x>0){
                      ...
                      while ($row = $stmtArea->fetch(PDO::FETCH_BOUND)) {
                        ...
                        $sql = "SELECT ppm.cod_planilla,ppm.cod_personalcargo,ppm.cod_gradoacademico,ppm.dias_trabajados,ppm.horas_pagadas,ppm.haber_basico,
                          ...
                          where ppm.cod_personalcargo=pad.cod_personal and pad.cod_estadoreferencial=1 and cod_planilla=$codigo_planilla and pad.cod_uo=$cod_uo_x and pad.cod_estadoreferencial=1 and pad.cod_area=$cod_area_x";
