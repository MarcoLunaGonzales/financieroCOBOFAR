                      ...
                      <td class="td-actions text-right">
                         ...
                         <div class="dropdown <?=$clase_boton_ver?>">
                          ...
                          <ul class="dropdown-menu" role="menu" aria-labelledby="reporte_sueldos">
                            ...
                            <li role="presentation"><a role="item" href="planillas/planillasRetroactivosCNS.php?codigo_planilla=<?=$codigo_planilla;?>&cod_gestion=<?=$cod_gestion;?>&tipo=2" target="_blank"><i class="material-icons text-danger">add_business</i><small>PLANILLA CPS</small></a></li>
