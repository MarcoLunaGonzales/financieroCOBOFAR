...
$html.='<header class="header">'.            
    '<table width="100%">
      ...
      <td><center><span style="font-size: 13px"><b>'.$string_titulo.'</b></span><BR>Correspondientes a los meses de enero a abril de '.$gestion.'<br><b>EXPRESADA EN BOLIVIANOS</b></center></td>
...
$html.='<table class="table">
    ...
    <tbody>';
			...
			$dias_trabajados_por_defecto=30;
				...
				$sql = "SELECT ppm.cod_personal,ppm.liquido_pagable,pad.primer_nombre,pad.paterno,pad.materno,
				(select c.nombre from cargos c where c.codigo=pad.cod_cargo)as cargo,pad.cuenta_bancaria,(select a.nombre from areas a where a.codigo=pad.cod_area) as areas,ppm.retiro_planilla
					from planillas_retroactivos_detalle ppm,personal pad
					where ppm.cod_personal=pad.codigo and cod_planilla=$cod_planilla $sql_add order by correlativo_planilla";
					// echo $sql."<br><br>";
				...
				{  
					...
					if($retiro_planilla>date('Y-01-01')){
						$areas="PERSONAL RETIRADO";
					}
    ...
    <tfoot>
 	...
 	<tr><td><center><p>______________________________<br></p></center></td></tr>
 	</table>';
$html.='</body>'.
      '</html>';
      ...
      $stmtPersonal=null;
// echo $html;
descargarPDFBoleta("Planilla_retroactivos_".$gestion,$html);

//'.obtenerValorConfiguracionPlanillas(23).'<br>JEFE DE SISTEMAS
?>
