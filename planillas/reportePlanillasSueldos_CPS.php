        ...
        <div class="card">
          <div class="card-header <?=$colorCard;?> card-header-icon">
            <div class="card-icon bg-blanco">
             ...
             <h4 class="card-title text-center">PLANILLA DE SUELDOS Y SALARIOS<br>CORRESPONDIENTE AL MES DE <?=$mes?> DE <?=$gestion?><br>EXPRESADO EN BOLIVIANOS</h4>
          </div>
          <div class="card-body">
