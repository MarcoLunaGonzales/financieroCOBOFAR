  ...
  <?php
    ...
    header("Expires: 0");
    $filename = "COBOFAR - ESTADOS DE RESULTADOS ALL.xls";
...
$html.='<br><table class="table"><tr style="background:#FA8072;font-size:14px"><td colspan="6"><center><b>'.nameArea($area_costo[1]).'</b></center></td></tr></table>';
