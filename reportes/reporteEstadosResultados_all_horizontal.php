  ...
  <?php
    ...
    header("Expires: 0");
    $filename = "COBOFAR - ESTADOS DE RESULTADOS Horizontal.xls";
...
$area_costo_main=$_POST['area_costo'];
...
$html.=  '<header class="header">'.            
          ...
          '</header>';
         $html.='<table class="table"><tr><td><b>Numero Cuenta</b></td><td><b>Nombre Cuenta</b></td><td><b>Sucursal</b></td><td><b>Monto</b></td></tr></table>';
for ($ix=0; $ix < count($area_costo_main); $ix++) { 
  $area_costo[1]=$area_costo_main[$ix];
// $html.='<br><table class="table"><tr style="background:#FA8072;font-size:14px"><td ><center><b>'.nameArea($area_costo[1]).'</b></center></td><td></td><td></td><td></td><td></td></tr></table>';
                     ...
                     if($codigo==5000){                    
                      ...
                      if($montoX>0){
                        $html4.='<tr>'.
                             ...
                             '<td class="td-border-none text-right">'.nameArea($area_costo[1]).'</td>'.
