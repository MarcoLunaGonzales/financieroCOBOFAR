...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="col-md-12">
      <form id="form1" class="form-horizontal" action="reportes_activosfijos/reporte_depreciacion_mes_consolidado_print.php" method="post" target="_blank">
      <div class="card">
        <div class="card-header <?=$colorCard;?> card-header-text">
        <div class="card-text">
          <h4 class="card-title">Depreciación Activos Fijos Consolidado por Areas</h4>
        </div>
        </div>
        <div class="card-body ">
          <div class="row">
