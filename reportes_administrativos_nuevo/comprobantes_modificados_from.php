            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header <?=$colorCard;?> card-header-icon">
                  ...
                  <h4 class="card-title">Reporte Comprobantes Modificados</h4>
                </div>
                <form class="" action="comprobantes_modificados_print.php" target="_blank" method="POST">
                <div class="card-body">
	                  ...
	                  <div class="row">
				              ...
				              <div class="row">
												...
												<div class="col-sm-7">
												<div class="form-group">
												  <select class="selectpicker form-control form-control-sm" name="tipo" id="tipo"  data-actions-box="true" required data-live-search="true" multiple="true">
												    <option value="1">INGRESOS</option>
												    <option value="2">EGRESOS</option>
												    <option value="2">TRASPASOS</option>
												  </select>
												</div>
												</div>
												</div>
