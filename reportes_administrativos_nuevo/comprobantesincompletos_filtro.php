            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header <?=$colorCard;?> card-header-icon">
                  ...
                  <h4 class="card-title">Reporte Comprobantes Incompletos</h4>
                </div>
                <form class="" action="comprobantesincompletos_print.php" target="_blank" method="POST">
                <div class="card-body">
	                  <div class="row">
				            ...
				            <div class="row">
				              ...
				              <div class="col-sm-4">
				                <div class="form-group">
				                	<select name="tipo" id="tipo" class="selectpicker form-control form-control-sm" data-style="btn btn-primary"  data-show-subtext="true" data-live-search="true" required="true">
	                       		<option value="1">Solo Con Diferencia</option>
