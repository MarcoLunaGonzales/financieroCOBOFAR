      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header <?=$colorCard;?> card-header-icon">
            ...
            <h4 class="card-title">Reporte Movimientos Costo - Proveedor</h4>
          </div>
          <form class="" action="rptInv_movimientos_costo_proveedor.php" target="_blank" method="POST">
          <div class="card-body">
              <div class="row">
              	<label class="col-sm-2 col-form-label">Sucursal</label>
	                ...
	                <label class="col-sm-1 col-form-label">Proveedores</label>
                  <div class="col-sm-4">
                      <div class="form-group">
                          <select name="proveedor[]" id="proveedor" class="selectpicker form-control form-control-sm" data-style="btn btn-primary"  data-show-subtext="true" data-live-search="true" data-actions-box="true" multiple required="true">
                              <?php 
