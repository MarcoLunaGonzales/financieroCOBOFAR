...
for ($i=1;$i<=$cantidadFilas;$i++){	
    ...
    for($j=0;$j<$nF;$j++){
      ...
      $sqlDetalle2="INSERT INTO facturas_compra (cod_solicitudrecursodetalle, nit, nro_factura, fecha, razon_social, importe, exento, nro_autorizacion, codigo_control,ice,tasa_cero,tipo_compra) 
      VALUES ('$codComprobanteDetalle', '$nit', '$nroFac', '$fechaFac', '$razonFac', '$impFac', '$exeFac', '$autFac', '$conFac','$iceFac','$tazaFac','$tipoFac')";
