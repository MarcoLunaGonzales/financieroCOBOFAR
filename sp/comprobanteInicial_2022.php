      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header <?=$colorCard;?> card-header-icon">
            ...
            <h4 class="card-title">Cargado Inicial de Comprobantes 2022</h4>
          </div>
          <div class="card-body">
<?php
...
//INICIO PROCESO
// $fechaActual="2022-01-01"; //registro de comprobante
$gestion=2021;//GESTION QUE SE COPIARÁ
...
// $cod_gestionAnterior=3584;
// $cod_gestion=3684;
// $gestionInsertar=2022;
// $mes_gestion=1;
$glosa="BALANCE INICIAL 2022";
$codComprobante=16737;//obtenerCodigoComprobante(); // IBNORCA: 39843 LOCALHOST: 39084 comprobante INICIAL LA PAZ 
            ...
            while ($row = $stmt4->fetch(PDO::FETCH_BOUND)) {
              ...
              //listar los montos
               ...
               while ($rowComp = $detallesReporte->fetch(PDO::FETCH_ASSOC)) {
                   ...
                   $glosaX="COMPROBANTE INICIAL 2022";
                   $cuentaAuxiliarX=0;
                  ...
                  // if(!($cuentaX==2035||$cuentaX==1048||$cuentaX==1045||$cuentaX==5084||$cuentaX==5085||$cuentaX==1050||$cuentaX==2033||$cuentaX==1042||$cuentaX==5093||$cuentaX==5129||$cuentaX==1043||$cuentaX==5122||$cuentaX==5123||$cuentaX==1046||$cuentaX==5130||$cuentaX==5137||$cuentaX==2036||$cuentaX==2037||$cuentaX==5110||$cuentaX==2027||$cuentaX==2025||$cuentaX==2026||$cuentaX==2028||$cuentaX==2031||$cuentaX==5142||$cuentaX==5112||$cuentaX==5143||$cuentaX==5099||$cuentaX==5108||$cuentaX==5094||$cuentaX==5083||$cuentaX==5128||$cuentaX==5192||$cuentaX==5144||$cuentaX==2029||$cuentaX==1054)){ //omitir el cargado de estas cuentas
