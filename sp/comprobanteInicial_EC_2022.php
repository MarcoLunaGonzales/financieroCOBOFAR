      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header <?=$colorCard;?> card-header-icon">
            ...
            <h4 class="card-title">Cargado Inicial de Comprobantes CON EC 2022</h4>
          </div>
          <div class="card-body">
<?php
...
// $gestion = 2021;//gestion que se cargará
...
$cuenta[0] = 5084;//cuentas que se cargarán;

// $proveedoresString="1672,1679,2219,2220,2223,7498,8744,8775,8776,8845,8864,9586,9587,9588,9637,9638";
$proveedoresString="";
