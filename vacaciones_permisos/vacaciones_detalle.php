...
<!-- Modal Add vacaciones General -->
<div class="modal fade" id="modalAgregarGeneral" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background: #212f3d;">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="ing_planilla_g" id="ing_planilla_g" value="<?=$ing_planilla?>">
        <input type="hidden" name="fecha_actual_g" id="fecha_actual_g" value="<?=$fecha_actual?>">
        <input type="hidden" name="saldo_modal_g" id="saldo_modal_g" value="<?=$total_dias_vacacion_saldo?>">
        <input type="hidden" name="gestion_modal_g" id="gestion_modal_g" value="-100">
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
        ...
        <div class="row">
          ...
          <div class="col-sm-9">
            <div class="form-group">
              <INPUT  type='text' class='form-control'  id='observaciones_modal_g' name='observaciones_modal_g' required>
            </div>
          </div>
        </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" id="registrarGeneral" name="registrarGeneral" data-dismiss="modal">Guardar</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal">  Cerrar </button>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#registrarGeneral').click(function(){    
      codigo_personal_modal=document.getElementById("codigo_personal_modal_g").value;
      gestion_modal=document.getElementById("gestion_modal_g").value;
      ing_planilla=document.getElementById("ing_planilla_g").value;
      fecha_actual=document.getElementById("fecha_actual_g").value;
      saldo_modal=document.getElementById("saldo_modal_g").value;
      observaciones_modal=document.getElementById("observaciones_modal_g").value;

      dias_vacacion=$('#dias_vacacion_g').val();
      fecha_inicio_modal=$('#fecha_inicio_modal_g').val();
      // console.log(fecha_inicio_modal);
      fecha_final_modal=$('#fecha_final_modal_g').val();
          ...
          if(dias_vacacion=="" || dias_vacacion==0){//|| dias_vacacion>saldo_modal
            ...
            if(tipo_vacacion=="" || tipo_vacacion==0){
              ...
              if((fecha_inicio_modal=="" || fecha_final_modal=="") && tipo_vacacion!=3 ){
                ...
                RegistrarVacacionesPersonalGral(codigo_personal_modal,gestion_modal,dias_vacacion,fecha_inicio_modal,fecha_final_modal,tipo_vacacion,ing_planilla,fecha_actual,observaciones_modal);    
              }  
            }
          }
        }
